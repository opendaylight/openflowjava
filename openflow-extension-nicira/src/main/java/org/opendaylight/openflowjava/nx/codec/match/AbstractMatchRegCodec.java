...
import org.opendaylight.yang.gen.v1.urn.opendaylight.groupbasedpolicy.of.extension.nicira.match.rev140421.ofj.nxm.nx.match.reg.grouping.MatchRegValuesBuilder;
...
public abstract class AbstractMatchRegCodec extends AbstractMatchCodec {
    ...
    public MatchEntries deserialize(ByteBuf message) {
        ...
        augNxMatchBuilder.setMatchRegValues(new MatchRegValuesBuilder().setValue(message.readUnsignedInt()).build());
    ...
    public void serialize(MatchEntries input, ByteBuf outBuffer) {
        ...
        Long value = input.getAugmentation(OfjAugNxMatch.class).getMatchRegValues().getValue();
