...
public class MatchTunIdCodec extends AbstractMatchCodec {
    ...
    public static final MatchEntrySerializerKey<Nxm1Class, NxMatchTunId> SERIALIZER_KEY = new MatchEntrySerializerKey<>(
            EncodeConstants.OF13_VERSION_ID, Nxm1Class.class, NxMatchTunId.class);
