...
import org.opendaylight.yang.gen.v1.urn.opendaylight.groupbasedpolicy.of.extension.nicira.match.rev140421.ofj.nxm.nx.match.tun.id.grouping.MatchTunIdValuesBuilder;
...
public class MatchTunIdCodec extends AbstractMatchCodec {
    ...
    public void serialize(MatchEntries input, ByteBuf outBuffer) {
        ...
        BigInteger value = input.getAugmentation(OfjAugNxMatch.class).getMatchTunIdValues().getValue();
    ...
    public MatchEntries deserialize(ByteBuf message) {
        ...
        augNxMatchBuilder.setMatchTunIdValues(new MatchTunIdValuesBuilder().setValue(BigInteger.valueOf(message.readLong()))
                .build());
