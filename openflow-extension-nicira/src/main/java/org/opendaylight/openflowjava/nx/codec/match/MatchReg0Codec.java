...
public class MatchReg0Codec extends AbstractMatchRegCodec {
    ...
    private static final Class<NxMatchReg0> NXM_FIELD_CLASS = NxMatchReg0.class;
    public static final EnhancedMessageTypeKey<Nxm1Class, NxMatchReg0> MESSAGE_TYPE_KEY = new EnhancedMessageTypeKey<>(
