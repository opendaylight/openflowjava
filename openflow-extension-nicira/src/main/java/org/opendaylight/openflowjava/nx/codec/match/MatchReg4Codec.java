...
public class MatchReg4Codec extends AbstractMatchRegCodec {
    ...
    private static final Class<NxMatchReg4> NXM_FIELD_CLASS = NxMatchReg4.class;
    public static final EnhancedMessageTypeKey<Nxm1Class, NxMatchReg4> MESSAGE_TYPE_KEY = new EnhancedMessageTypeKey<>(
