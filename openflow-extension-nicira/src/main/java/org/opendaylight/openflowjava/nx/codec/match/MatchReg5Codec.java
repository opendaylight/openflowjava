...
public class MatchReg5Codec extends AbstractMatchRegCodec {
    ...
    private static final Class<NxMatchReg5> NXM_FIELD_CLASS = NxMatchReg5.class;
    public static final EnhancedMessageTypeKey<Nxm1Class, NxMatchReg5> MESSAGE_TYPE_KEY = new EnhancedMessageTypeKey<>(
