...
public class MatchReg2Codec extends AbstractMatchRegCodec {
    ...
    private static final Class<NxMatchReg2> NXM_FIELD_CLASS = NxMatchReg2.class;
    public static final EnhancedMessageTypeKey<Nxm1Class, NxMatchReg2> MESSAGE_TYPE_KEY = new EnhancedMessageTypeKey<>(
