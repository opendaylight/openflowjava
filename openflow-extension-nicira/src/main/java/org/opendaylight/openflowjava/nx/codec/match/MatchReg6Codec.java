...
public class MatchReg6Codec extends AbstractMatchRegCodec {
    ...
    private static final Class<NxMatchReg6> NXM_FIELD_CLASS = NxMatchReg6.class;
    public static final EnhancedMessageTypeKey<Nxm1Class, NxMatchReg6> MESSAGE_TYPE_KEY = new EnhancedMessageTypeKey<>(
