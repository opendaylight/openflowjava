...
public class MatchReg3Codec extends AbstractMatchRegCodec {
    ...
    public static final MatchEntrySerializerKey<Nxm1Class, NxMatchReg3> SERIALIZER_KEY = new MatchEntrySerializerKey<>(
            EncodeConstants.OF13_VERSION_ID, Nxm1Class.class, NxMatchReg3.class);
