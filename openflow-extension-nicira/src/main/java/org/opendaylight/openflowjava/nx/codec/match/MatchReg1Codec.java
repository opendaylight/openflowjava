...
public class MatchReg1Codec extends AbstractMatchRegCodec {
    ...
    public static final MatchEntrySerializerKey<Nxm1Class, NxMatchReg1> SERIALIZER_KEY = new MatchEntrySerializerKey<>(
            EncodeConstants.OF13_VERSION_ID, Nxm1Class.class, NxMatchReg1.class);
