...
public class MatchReg7Codec extends AbstractMatchRegCodec {
    ...
    private static final Class<NxMatchReg7> NXM_FIELD_CLASS = NxMatchReg7.class;
    public static final EnhancedMessageTypeKey<Nxm1Class, NxMatchReg7> MESSAGE_TYPE_KEY = new EnhancedMessageTypeKey<>(
