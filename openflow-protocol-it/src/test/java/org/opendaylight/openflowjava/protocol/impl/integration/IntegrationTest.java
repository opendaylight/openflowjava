...
public class IntegrationTest {
    ...
    public void testHandshake() throws Exception {
        ...
        Stack<ClientEvent> scenario = new Stack<>();
        scenario.add(0, new SendEvent(ByteBufUtils.hexStringToBytes("04 00 00 08 00 00 00 01")));
        scenario.add(0, new WaitForMessageEvent(ByteBufUtils.hexStringToBytes("04 00 00 08 01 02 03 04")));
        scenario.add(0, new WaitForMessageEvent(ByteBufUtils.hexStringToBytes("04 05 00 08 01 02 03 04")));
        scenario.add(0, new SendEvent(ByteBufUtils.hexStringToBytes("04 06 00 20 01 02 03 04 "
    ...
    public void testHandshakeAndEcho() throws Exception {
        ...
        ScenarioHandler handler = new ScenarioHandler(scenario);
        LOGGER.info("scenHan empty ?: " + handler.isEmpty());
        List<SimpleClient> clients = createAndStartClient(amountOfCLients, handler);
        SimpleClient firstClient = clients.get(0);
        firstClient.getScenarioDone().get();
        mockPlugin.shutdown();
