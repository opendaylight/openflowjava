...
public class IntegrationTest {
    ...
    public void setUp(boolean secured) throws Exception {
        ...
        if (secured) {
            tlsConfiguration = new TlsConfigurationImpl("JKS", "../openflow-protocol-impl/src/main/resources/selfSignedSwitch",
                    "path", true, "JKS", "../openflow-protocol-impl/src/main/resources/selfSignedController", "path") ;
