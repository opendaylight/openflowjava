...
public class SerializerRegistryImpl implements SerializerRegistry {
    ...
    public void init() {
        ...
        ((RegistryInjector) of10FlowModInputMessageFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) of10StatsRequestInputFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) of10PacketOutInputMessageFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) flowModInputMessageFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) groupModInputMessageFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) multipartRequestInputFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) packetOutInputMessageFactory).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) of13MatchSerializer).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) of10ActionsSerializer).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) of13ActionsSerializer).injectSerializerRegistry(this);
        ...
        ((RegistryInjector) of13InstructionsSerializer).injectSerializerRegistry(this);
