...
/**
 * Class primary implement methods from generated OpenflowProtocolSevices
...
abstract class AbstractConnectionAdapter implements ConnectionAdapter {
    ...
    protected abstract <T> ListenableFuture<RpcResult<T>> enqueueMessage(final AbstractRpcListener<T> promise);
}
