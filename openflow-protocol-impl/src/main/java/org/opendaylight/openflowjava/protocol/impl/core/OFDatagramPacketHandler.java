...
public class OFDatagramPacketHandler extends MessageToMessageDecoder<DatagramPacket> {
     ...
     */
    public OFDatagramPacketHandler(SwitchConnectionHandler sch, int outboundQueueSize) {
    ...
    protected void decode(ChannelHandlerContext ctx, DatagramPacket msg,
        ...
        if (consumer == null) {
            ConnectionFacade connectionFacade =
                    adapterFactory.createConnectionFacade(ctx.channel(), msg.sender(), outboundQueueSize);
