...
public abstract class OF10ActionsSerializer {
    ...
    private static void encodeGenericAction(byte code, ByteBuf out) {
        final byte GENERIC_ACTION_LENGTH = 8;
        final byte PADDING_IN_GENERIC_ACTION = 4;
        out.writeShort(code);
    ...
    private static void encodeSetVlanVidAction(Action action, ByteBuf out) {
        final byte SET_VLAN_VID_CODE = 1;
        final byte SET_VLAN_VID_LENGTH = 8;
    ...
    private static void encodeSetVlanPcpAction(Action action, ByteBuf out) {
        final byte SET_VLAN_PCP_CODE = 2;
        final byte SET_VLAN_PCP_LENGTH = 8;
    ...
    private static void encodeDlAddressAction(Action action, ByteBuf out, byte code) {
        final byte DL_ADDRESS_ACTION_LENGTH = 16;
        final byte PADDING_IN_DL_ADDRESS_ACTION = 6;
        out.writeShort(code);
    ...
    private static void encodeNwTosAction(Action action, ByteBuf out) {
        final byte SET_NW_TOS_CODE = 2;
        final byte SET_NW_TOS_LENGTH = 8;
        final byte PADDING_IN_SET_NW_TOS_ACTION = 3;
    ...
    private static void encodeIpAddressAction(Action action, ByteBuf out, byte code) {
        final byte IP_ADDRESS_ACTION_LENGTH = 8;
        out.writeShort(code);
    ...
    private static void encodeTpPortAction(Action action, ByteBuf out, byte code) {
        final byte TP_PORT_ACTION_LENGTH = 8;
        final byte PADDING_IN_TP_PORT_ACTION = 2;
        out.writeShort(code);
    ...
    private static void encodeEnqueueAction(Action action, ByteBuf out) {
        final byte ENQUEUE_CODE = 11;
        final byte ENQUEUE_LENGTH = 16;
