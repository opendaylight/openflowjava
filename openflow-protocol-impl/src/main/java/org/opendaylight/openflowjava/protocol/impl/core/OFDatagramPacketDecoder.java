 ...
 *
 */
public class OFDatagramPacketDecoder extends MessageToMessageDecoder<UdpVersionMessageWrapper>{
    ...
    protected void decode(ChannelHandlerContext ctx,
            UdpVersionMessageWrapper msg, List<Object> out) throws Exception {
