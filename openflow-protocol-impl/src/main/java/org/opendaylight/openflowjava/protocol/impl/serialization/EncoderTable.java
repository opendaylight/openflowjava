...
import org.opendaylight.openflowjava.protocol.impl.serialization.factories.OF10StatsRequestMessageFactory;
...
public class EncoderTable {
    ...
    public void init() {
        ...
        table.put(new MessageTypeKey<>(OF10, MultipartRequestInput.class), OF10StatsRequestMessageFactory.getInstance());
        ...
        table.put(new MessageTypeKey<>(OF13, MultipartRequestInput.class), MultipartRequestMessageFactory.getInstance());
