...
public class InstructionDeserializerInitializer {
    ...
    public static void registerDeserializers(DeserializerRegistry registry) {
        ...
        helper.registerDeserializer(1, null, new GoToTableInstructionDeserializer());
        helper.registerDeserializer(2, null, new WriteMetadataInstructionDeserializer());
        helper.registerDeserializer(3, null, new WriteActionsInstructionDeserializer());
        helper.registerDeserializer(4, null, new ApplyActionsInstructionDeserializer());
        helper.registerDeserializer(5, null, new ClearActionsInstructionDeserializer());
        helper.registerDeserializer(6, null, new MeterInstructionDeserializer());
    }
}