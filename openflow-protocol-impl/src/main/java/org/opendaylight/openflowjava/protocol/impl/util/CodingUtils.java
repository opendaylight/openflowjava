...
public abstract class CodingUtils {
     ...
     */
    public static <T> void serializeList(List<T> list, OFSerializer<T> serializer, ByteBuf outBuffer){
        if (list != null) {
            for (T item : list) {
     ...
     * @param outBuffer output buffer
     */
    public static <T> void serializeHeaders(List<T> list, HeaderSerializer<T> serializer, ByteBuf outBuffer){
        if (list != null) {
            for (T item : list) {
