...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.instruction.rev130731.instructions.grouping.Instructions;
...
public class InstructionsDeserializerTest {
    ...
    public void test() {
        ...
        List<Instructions> instructions = InstructionsDeserializer.createInstructions(message, message.readableBytes());
        Instructions i1 = instructions.get(0);
        ...
        Instructions i2 = instructions.get(1);
        ...
        Instructions i3 = instructions.get(2);
        ...
        Assert.assertEquals("Wrong instructions - i3", 0, i3.getAugmentation(ActionsInstruction.class).getActionsList().size());
        Instructions i4 = instructions.get(3);
        ...
        Instructions i5 = instructions.get(4);
        ...
        Assert.assertEquals("Wrong instructions - i5", 2, i5.getAugmentation(ActionsInstruction.class).getActionsList().size());
        Action action1 = i5.getAugmentation(ActionsInstruction.class).getActionsList().get(0).getAction();
        ...
        Action action2 = i5.getAugmentation(ActionsInstruction.class).getActionsList().get(1).getAction();
        ...
        Instructions i6 = instructions.get(5);
        ...
        Assert.assertEquals("Wrong instructions - i6", 2, i6.getAugmentation(ActionsInstruction.class).getActionsList().size());
        action1 = i6.getAugmentation(ActionsInstruction.class).getActionsList().get(0).getAction();
        ...
        action2 = i6.getAugmentation(ActionsInstruction.class).getActionsList().get(1).getAction();
