...
public class OFVersionDetectorTest {
    ...
    @Test
    public void testDecode15ProtocolMessage() {
        detector.decode(channelHandlerContext, ByteBufUtils.hexStringToByteBuf("06 00 00 08 00 00 00 01"), list);
        Assert.assertEquals(7, ((VersionMessageWrapper) list.get(0)).getMessageBuffer().readableBytes());
    }

    @Test
    public void testDecode14ProtocolMessage() {
