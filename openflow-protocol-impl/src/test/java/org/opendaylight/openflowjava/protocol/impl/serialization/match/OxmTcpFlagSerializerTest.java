...
public class OxmTcpFlagSerializerTest {

    OxmTcpFlagSerializer serializer = new OxmTcpFlagSerializer();
 ...
 *           */
    ...
    public void getOxmFieldCode() {
        assertEquals("Wrong oxm-class", OxmMatchConstants.OFPXMT_OFB_TCP_FLAGS, serializer.getOxmFieldCode());
    }
 ...
 *           */
    ...
    private static MatchEntryBuilder prepareMatchEntry(int value) {
        ...
        TcpFlagBuilder valueBuilder = new TcpFlagBuilder();
        valueBuilder.setFlag(value);
        casebuilder.setTcpFlag(valueBuilder.build());
    ...
    private static MatchEntryBuilder prepareHeader(boolean hasMask) {
        ...
        builder.setOxmMatchField(TcpFlag.class);
    ...
    private static void checkHeader(ByteBuf buffer, boolean hasMask) {
        ...
        assertEquals("Wrong oxm-field", OxmMatchConstants.OFPXMT_OFB_TCP_FLAGS, fieldAndMask >>> 1);
