 ...
 * @param <CLAZZ> object being serialized (its class) - in this case {@link Instruction}.class
 * @param <TYPE> action type
 */
public class InstructionSerializerKey<CLAZZ extends DataObject,
        TYPE extends InstructionBase> extends MessageTypeKey<CLAZZ>{
     ...
     */
    public InstructionSerializerKey(short msgVersion, Class<CLAZZ> objectType,
            Class<TYPE> instructionType, Long experimenterId) {
