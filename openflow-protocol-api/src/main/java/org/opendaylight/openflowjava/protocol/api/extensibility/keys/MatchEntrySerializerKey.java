 ...
 * @param <CLAZZ> object being serialized (its class) - in this case {@link MatchEntries}.class
 * @param <OXM_CLASS> oxm_class (see specification)
 * @param <OXM_FIELD> oxm_field (see specification)
 */
public class MatchEntrySerializerKey<CLAZZ extends DataObject,
        OXM_CLASS extends Clazz, OXM_FIELD extends MatchField> extends MessageTypeKey<CLAZZ>{
     ...
     */
    public MatchEntrySerializerKey(short msgVersion, Class<CLAZZ> objectType,
            Class<OXM_CLASS> oxmClass, Class<OXM_FIELD> oxmField) {
